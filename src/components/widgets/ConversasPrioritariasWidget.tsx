  ...
  return (
    <div 
      className={cn(
        ...
        isVeryUrgent && 'border-red-100 bg-red-50/30 hover:bg-red-50/50',
        isUrgent && 'border-amber-100 bg-amber-50/30 hover:bg-amber-50/50'
      )}
          ...
          <div className="flex items-center justify-between gap-2 mb-2">
            ...
            <Badge 
              ...
              className={cn(
                ...
                isVeryUrgent && "bg-red-100 text-red-700 border-red-200",
                isUrgent && "bg-amber-100 text-amber-700 border-amber-200",
                !isVeryUrgent && !isUrgent && "bg-gray-100 text-gray-600 border-gray-200"
              )}
            >
      ...
      <CardHeader className="pb-4">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            <div className={cn(
              'p-2 rounded-lg',
              veryUrgentCount > 0 ? 'bg-red-50 text-red-600' : 
              urgentCount > 0 ? 'bg-amber-50 text-amber-600' : 'bg-blue-50 text-blue-600'
            )}>
      ...
      <CardContent className="pt-0">
        ...
        {conversas.length > 0 && (
          <div className="mt-6 pt-4 border-t border-gray-100">
            <Button 
              variant="outline" 
              className="w-full h-10 text-sm font-medium hover:bg-gray-50 border-gray-200"
              size="sm"
            >
