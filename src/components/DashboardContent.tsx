        ...
        component: (
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900">Métricas da Equipe</h3>
            </div>
            {data.metricasEquipe ? (
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-lg">
                  <div className="text-3xl font-bold text-blue-700 mb-1">{data.metricasEquipe.totalNovosClientes}</div>
                  <div className="text-sm font-medium text-blue-600">Novos Clientes</div>
                </div>
                <div className="text-center p-4 bg-gradient-to-br from-green-50 to-green-100/50 rounded-lg">
                  <div className="text-3xl font-bold text-green-700 mb-1">{data.metricasEquipe.tempoMedioResposta.toFixed(1)}h</div>
                  <div className="text-sm font-medium text-green-600">Tempo Médio</div>
                </div>
                <div className="text-center p-4 bg-gradient-to-br from-purple-50 to-purple-100/50 rounded-lg">
                  <div className="text-3xl font-bold text-purple-700 mb-1">{data.metricasEquipe.negociosFechados}</div>
                  <div className="text-sm font-medium text-purple-600">Fechados</div>
                </div>
                <div className="text-center p-4 bg-gradient-to-br from-orange-50 to-orange-100/50 rounded-lg">
                  <div className="text-3xl font-bold text-orange-700 mb-1">{data.metricasEquipe.taxaSucesso.toFixed(1)}%</div>
                  <div className="text-sm font-medium text-orange-600">Taxa Sucesso</div>
                </div>
              </div>
            ) : (
        ...
        component: (
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900">Conversas que Exigem Atenção</h3>
            </div>
            {data.conversasRisco ? (
              data.conversasRisco.length > 0 ? (
                <div className="space-y-3">
                  {data.conversasRisco.map(conversa => (
                    <div key={conversa.id} className="p-4 bg-gradient-to-r from-red-50 to-orange-50 border border-red-100 rounded-lg hover:shadow-sm transition-shadow">
                      <div className="flex items-center justify-between">
                        <div className="flex-1">
                          <div className="font-semibold text-gray-900">{conversa.cliente.nome}</div>
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600 font-medium">Nenhuma conversa em risco</p>
                  <p className="text-sm text-gray-500">Sua equipe está em dia!</p>
                </div>
              )
            ) : (
              <Skeleton className="h-20 w-full" />
        ...
        component: (
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900">Ranking da Equipe</h3>
            </div>
            {data.rankingEquipe ? (
              data.rankingEquipe.length > 0 ? (
                <div className="space-y-3">
                  {data.rankingEquipe.map((item, index) => (
                    <div key={index} className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-gray-100/50 rounded-lg border border-gray-100">
                      <div className="flex items-center gap-4">
                        ...
                        <span className="font-semibold text-gray-900">{item.corretor.nome}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="font-bold text-lg text-gray-900">{item.pontuacao}</span>
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600 font-medium">Dados insuficientes para ranking</p>
                  <p className="text-sm text-gray-500">Continue trabalhando para aparecer aqui!</p>
                </div>
              )
            ) : (
    ...
    <div className="flex-1 bg-gradient-to-br from-gray-50 to-gray-100/50">
      ...
      {isLoading && data && (
        <div className="w-full h-1 bg-gray-200 relative overflow-hidden">
          <div className="absolute left-0 top-0 h-full bg-gradient-to-r from-blue-500 to-purple-600 animate-pulse w-2/3 rounded-r-full"></div>
        </div>
      )}
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            <h1 className="text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">
              {viewContext.viewMode === 'self' ? 'Meu Dashboard' : 
          ...
          <div className="flex items-center gap-3 px-4 py-3 bg-white rounded-xl border border-gray-100 shadow-sm">
            ...
            <span className="text-sm font-medium text-gray-700">Dados atualizados</span>
            {isLoading && (
